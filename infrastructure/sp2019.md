...
First of all, you will need git and Vagrant installed. Here is example how you can install them in Windows PowerShell.
...
Make sure that your in your subscription there is a resource group for images called "CommonRG", or change the name in `/infrastructure/images/sp-win2016-ad-db-sp2019-code.json` and `/infrastructure/stacks/dev-2019/Vagrantfile` files.
...
4. Open `/infrastructure/stacks/dev-2019` directory in console.
For example, in Windows:

```
cd c:\projects\sp-devops-starter\stacks\dev-2019
```
...
```
    ADDBWEBCODE01: VERBOSE: [addbwebcode01]:                            [[SPSite]DefaultPathSite] Leaving EndProcessing
Method of
    ADDBWEBCODE01: Get-SPSite.
    ADDBWEBCODE01: VERBOSE: [addbwebcode01]: LCM:  [ End    Test     ]  [[SPSite]DefaultPathSite] True in 1.2180 seconds
.
    ADDBWEBCODE01: VERBOSE: [addbwebcode01]: LCM:  [ End    Resource ]  [[SPSite]DefaultPathSite]
    ADDBWEBCODE01: VERBOSE: [addbwebcode01]: LCM:  [ End    Compare  ]     Completed processing compare operation. The o
peration returned
    ADDBWEBCODE01: True.
    ADDBWEBCODE01: VERBOSE: [addbwebcode01]: LCM:  [ End    Compare  ]    in  5.0310 seconds.
    ADDBWEBCODE01: VERBOSE: Operation 'Invoke CimMethod' complete.
    ADDBWEBCODE01: VERBOSE: Time taken for configuration job to complete is 5.104 seconds
```
