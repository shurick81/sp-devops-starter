    ...
    stages {
        stage('Infrastructure - Downloads') {
            ...
            steps {
                ...
                powershell 'cd sp2016dev; if ( !( Get-Item ./images/packer_cache/524abd34eb2abcc5e5a12da5b1c97fa3a6a626a831c29b4e74801f4131fb08ed.iso -ErrorAction Ignore ) ) { exit 1 }'
